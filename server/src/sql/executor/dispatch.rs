...
use super::super::parser::{parse, parse_any_expression};
...
impl Executor {
    ...
    pub(crate) async fn exec_prepare(&self, stmt: crate::sql::ast::PrepareStmt) -> SqlResult<QueryResult> {
    ...
    pub(crate) async fn exec_execute(&self, stmt: crate::sql::ast::ExecuteStmt, params: Vec<Value>, transaction_id: Option<String>) -> SqlResult<QueryResult> {
        ...
        if !stmt.params.is_empty() {
            ...
            for p in &stmt.params {
                ...
                let val = crate::sql::eval::evaluate_expression_joined(self, p, &[], &params, &[], &state)?;
